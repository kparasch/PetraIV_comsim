...
SC.plot = False
repr_file = f'after_orbit_BBA_seed{seed}.repr'
...
for _ in range(3):
    ...
    correct_tune(SC, ideal_tune, iTRM, qf1, qd02, gain=0.3, niter=5)
...
ax2.plot(bp0[1], '.')
ax2.plot(bp1[1], '.')
pSC._save_and_check_repr(SC.RING, f'after_2nd_tune_orbit_seed{seed}.repr')
